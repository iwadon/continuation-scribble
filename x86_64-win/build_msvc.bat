...
REM
REM Usage:
REM   build_msvc.bat          - Build x86_64_ctx_test.exe (default)
...
set "BUILDDIR=%SRCDIR%\..\build\x86_64-win"
set "ROOTDIR=%SRCDIR%\.."
...
ml64 /nologo /c /Zi /Fo"%BUILDDIR%\x86_64_ctx.obj" "%SRCDIR%\x86_64_ctx.asm"
if errorlevel 1 exit /b 1

echo [CC] x86_64_ctx_test.c
cl /nologo /W4 /Od /Zi /I "%SRCDIR%" /c /Fo"%BUILDDIR%\x86_64_ctx_test.obj" "%SRCDIR%\x86_64_ctx_test.c"
if errorlevel 1 exit /b 1
...
ml64 /nologo /c /Zi /Fo"%BUILDDIR%\fiber_trampoline.obj" "%SRCDIR%\fiber_trampoline.asm"
if errorlevel 1 exit /b 1
...
ml64 /nologo /c /Zi /Fo"%BUILDDIR%\cont_trampoline.obj" "%SRCDIR%\cont_trampoline.asm"
if errorlevel 1 exit /b 1
